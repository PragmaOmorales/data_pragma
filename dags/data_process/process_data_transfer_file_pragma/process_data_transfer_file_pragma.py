...
from dags.data_process.process_data_transfer_file_pragma.utils.general_utils import (
    decide_processing_path, process_transaction_file, 
...
def process_data_transfer_file_pragma():
    """DAG Definition."""
    ...
    process_file >> slack_stats_notification >> slack_trx_notification
...
dag = process_data_transfer_file_pragma()